...
%>
 ...
 <body>
  <form action="method!courseadd2" method="post"  >
     ...
     <div id="forms" class="mt10">
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">添加课程信息</b></div>
            <div class="box_center">
               ...
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="biaoti" class="input-text lh30" size="30">
                  </td>
                  </tr>
                 ...
                 <tr>
                  ...
                  <td class="">
                    <textarea name="jianjie" id="" cols="30" rows="10" class="textarea"></textarea>
                  </td>
                 </tr>
                 
                 
                   <tr>
                  <td class="td_right">课程资源上传:</td>
                  <td class="">
