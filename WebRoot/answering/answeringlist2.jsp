              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                ...
                <tr class="tr">
                    ...
                    <td >${bean.createDate }</td>
                     ...
                     <c:if test="${bean.rescontent==null}">
                      <input type="button"  class="btn btn82 btn_config" value="回复" onclick="location.href='method!answeringupdate?id=${bean.id }'"/>
                    </c:if>
                   </c:if>
                      <input type="button"  class="btn btn82 btn_config" value="删除" onclick="location.href='method!answeringdelete?id=${bean.id }'"/>
