...
<script language="javascript" type="text/javascript" src="js/jquery.min.js"></script>
	...
	<body>
<form action="method!t_userupdate2" method="post"  >
          ...
          <div class="box_border">
            ...
            <div class="box_center">
               ...
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                  <td class="td_right">学院:</td>
                  <td class=""> 
                    <select style="width:150px" class="input-text lh30" name="college" id="collegeid"> 
                      <option value="">--请选择--</option>
                        <c:forEach items="${list}" var="bean2">
                            <option value="${bean2.id }" <c:if test="${bean2.id==bean.college.id }">selected</c:if>>${bean2.name}</option>
                         </c:forEach>
                      </select>
                  </td>
                 </tr>
